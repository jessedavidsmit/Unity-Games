...
public class TextController : MonoBehaviour {
	...
	public Text text;
	private enum States {start, cell, mirror, sheets_0, lock_0, cell_mirror, sheets_1, lock_1, corridor_0, stairs_0, stairs_1,
		stairs_2, courtyard, floor, corridor_1, corridor_2, corridor_3,closet_door, in_closet};
	private States myState;
		
	public AudioSource jailOpenDoor;
	public AudioSource dressClothes;
	...
	void floor () {
		text.text = "Looking around on the dirty floor, you find a hairclip.\n\n" +
	...
	void start () 
	{
		text.text = "Welcome to the PRISON, press SPACE to start!";
	...
	void lock_0()
	{
		text.text = "This is one of those button locks. You have no idea what the " +
					"combination is. You wish you could somehow see where dirty " +
